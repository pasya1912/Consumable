...
class requestDetailExport implements FromView, WithStyles
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A'.$start.':Z' . ($start+$count))->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);
        $sheet->getStyle('A'.$start.':Z' . ($start+$count))->getAlignment()->setVertical(Alignment::VERTICAL_CENTER);
