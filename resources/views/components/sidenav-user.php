<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item <?=Request::routeIs('user.dashboard') ? 'active':''?>">
            <a href="<?=Request::routeIs('user.dashboard') ? '#':route('user.dashboard')?>" class="menu-link">
        ...
        <li class="menu-item <?=Request::routeIs('user.request*') ? 'active':''?>">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item <?=Request::routeIs('user.request') ? 'active':''?>">
                    <a href="<?= Request::routeIs('user.request') ? '#':route('user.request') ?>"
                        class="menu-link">
                        <div>Entry Form</div>
                    </a>
